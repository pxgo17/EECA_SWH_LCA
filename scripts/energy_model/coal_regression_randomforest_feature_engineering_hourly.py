...
# Load the dataset
data = pd.read_csv("C:/Users/pxg11/OneDrive - University of Canterbury/EECA_LCA_RFP//generation_data//thermal_fossil//coal_model_4y.csv")
...
subset = ['hourly_timestamp', 'Geo_Geo', 'interm', 'storage_GWh', 'inflow_MW', 'demand',
          'lag_coal','demand_next_8','geo_next_8','inflow_next_8','interm_next_8',
          'dispatch_mode']
...
joblib.dump(model_RF, 
            'C://Users//pxg11//OneDrive - University of Canterbury//EECA_LCA_RFP//energy_model//coal_dispatch.pkl')
