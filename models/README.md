...
These files are called by the energy_model_scenarios_github_17-6-2025.py script saved under scripts/energy_model
For further information about the scripts that were used to fit the models, please contact the repository author.